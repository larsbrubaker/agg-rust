...
var HISTORY_SECTIONS = [
  ...
  },
  {
    ...
    portUpdateNote: 'Rust-port update: references to the historical General Polygon Clipper are kept for context only. This project uses modern Rust approaches (including <a href="https://github.com/larsbrubaker/clipper2-rust" target="_blank" rel="noreferrer">clipper2-rust</a> workflows and the <a href="https://crates.io/crates/clipper2-rust" target="_blank" rel="noreferrer">clipper2-rust crate</a>) and does not ship GPC.'
  },
  {
    route: "history/news",
    title: "News",
  ...
  },
  {
    ...
    portUpdateNote: 'Rust-port update: the GPC component/license text is preserved historically, but GPC is not used in this Rust port. The Rust port uses <a href="https://github.com/larsbrubaker/clipper2-rust" target="_blank" rel="noreferrer">clipper2-rust</a>-based workflows and the <a href="https://crates.io/crates/clipper2-rust" target="_blank" rel="noreferrer">clipper2-rust crate</a> for modern polygon operations where needed.'
  },
  {
  ...
  container.innerHTML = `
    <div class="home-page">
      <div class="project-links">
        ...
        <a href="https://crates.io/crates/agg-rust" target="_blank" class="github-badge-link">
          <span>crates.io/agg-rust</span>
        </a>
        <a href="https://docs.rs/agg-rust" target="_blank" class="github-badge-link">
          <span>docs.rs/agg-rust</span>
        </a>
      </div>
      <div class="hero">
