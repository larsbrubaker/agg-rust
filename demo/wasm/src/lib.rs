...
/// Gouraud mesh: pick nearest editable vertex under cursor.
#[wasm_bindgen]
pub fn gouraud_mesh_pick_vertex(
    ...
    render::gouraud_mesh_pick_vertex(width, height, params, x, y, radius)
}
...
pub fn demo_names() -> String {
    "lion,gradients,gouraud,conv_stroke,bezier_div,circles,rounded_rect,aa_demo,gamma_correction,line_thickness,rasterizers,conv_contour,perspective,image_fltr_graph,image1,image_filters,gradient_focal,idea,graph_test,gamma_tuner,image_filters2,conv_dash_marker,aa_test,bspline,image_perspective,alpha_mask,alpha_gradient,image_alpha,alpha_mask3,image_transforms,mol_view,raster_text,gamma_ctrl,trans_polar,multi_clip,simple_blur,blur,trans_curve1,trans_curve2,lion_lens,distortions,blend_color,component_rendering,polymorphic_renderer,scanline_boolean,scanline_boolean2,pattern_fill,pattern_perspective,pattern_resample,lion_outline,rasterizers2,line_patterns,line_patterns_clip,compositing,compositing2,flash_rasterizer,flash_rasterizer2,rasterizer_compound,gouraud_mesh,image_resample,alpha_mask2,truetype_test".to_string()
}
